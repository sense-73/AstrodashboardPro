...
let lang = localStorage.getItem('ad_lang') || 'it';
	...
	i18n.it.info_map = "Mappa Empirica di Visibilità. Visualizza un raggio simbolico di 50 km per mostrarti a colpo d'occhio le reali condizioni del cielo. La sovrapposizione dei vari strati ti farà capire subito se la serata sarà limpida o compromessa. Usa i bottoni superiori per attivare i filtri meteo (Nuvole, Jet Stream, Umidità) e scorri la linea temporale per prevedere la loro evoluzione nelle prossime ore.";
        ...
        i18n.it.seeing_1_label = "Pessimo";
        i18n.it.seeing_2_label = "Turbolento";
        i18n.it.seeing_3_label = "Moderato";
        i18n.it.seeing_4_label = "Leggermente ondulato";
        i18n.it.seeing_5_label = "Perfetto";
        i18n.it.seeing_1_desc  = "Blob enorme e turbolento, inutilizzabile";
        i18n.it.seeing_2_desc  = "Blob diffuso irregolare, nessun anello";
        i18n.it.seeing_3_desc  = "Disco e anelli fusi, alone più ampio";
        i18n.it.seeing_4_desc  = "Anelli parzialmente mossi, brevi momenti di calma";
        i18n.it.seeing_5_desc  = "Disco di Airy e anelli stabili";
        i18n.it.seeing_scale_title = "Scala Seeing — Antoniadi";

        i18n.en.seeing_1_label = "Very bad";
        i18n.en.seeing_2_label = "Turbulent";
        i18n.en.seeing_3_label = "Moderate";
        i18n.en.seeing_4_label = "Slight undulations";
        i18n.en.seeing_5_label = "Perfect";
        i18n.en.seeing_1_desc  = "Huge turbulent blob, unusable";
        i18n.en.seeing_2_desc  = "Irregular diffuse blob, no rings";
        i18n.en.seeing_3_desc  = "Disk and rings merged, wider halo";
        i18n.en.seeing_4_desc  = "Rings partially blurred, brief moments of calm";
        i18n.en.seeing_5_desc  = "Airy disk and rings stable";
        i18n.en.seeing_scale_title = "Seeing Scale — Antoniadi";

        i18n.es.seeing_1_label = "Pésimo";
        i18n.es.seeing_2_label = "Turbulento";
        i18n.es.seeing_3_label = "Moderado";
        i18n.es.seeing_4_label = "Ligeramente ondulado";
        i18n.es.seeing_5_label = "Perfecto";
        i18n.es.seeing_1_desc  = "Blob enorme y turbulento, inutilizable";
        i18n.es.seeing_2_desc  = "Blob difuso irregular, sin anillos";
        i18n.es.seeing_3_desc  = "Disco y anillos fusionados, halo más amplio";
        i18n.es.seeing_4_desc  = "Anillos parcialmente borrosos, momentos de calma";
        i18n.es.seeing_5_desc  = "Disco de Airy y anillos estables";
        i18n.es.seeing_scale_title = "Escala Seeing — Antoniadi";

        i18n.zh.seeing_1_label = "极差";
        i18n.zh.seeing_2_label = "湍流";
        i18n.zh.seeing_3_label = "中等";
        i18n.zh.seeing_4_label = "轻微波动";
        i18n.zh.seeing_5_label = "完美";
        i18n.zh.seeing_1_desc  = "巨大湍流斑，无法使用";
        i18n.zh.seeing_2_desc  = "不规则弥散斑，无衍射环";
        i18n.zh.seeing_3_desc  = "艾里斑与衍射环融合，弥散晕更大";
        i18n.zh.seeing_4_desc  = "衍射环部分模糊，偶有平静时刻";
        i18n.zh.seeing_5_desc  = "艾里斑和衍射环稳定清晰";
        ...
        i18n.it.np_non_vale         = "Non Ne Vale la Pena";
        i18n.it.np_non_vale_tag     = "Condizioni difficili. Esci solo se hai un obiettivo specifico.";
        ...
        i18n.en.np_non_vale         = "Not Worth It";
        i18n.en.np_non_vale_tag     = "Tough conditions. Go out only if you have a specific target in mind.";
        ...
        i18n.es.np_non_vale         = "No Vale la Pena";
        i18n.es.np_non_vale_tag     = "Condiciones difíciles. Sal solo si tienes un objetivo específico.";
        ...
        i18n.zh.np_non_vale         = "不太值得";
        i18n.zh.np_non_vale_tag     = "条件较差，仅在有特定目标时考虑出门。";
