...
let lang = localStorage.getItem('ad_lang') || 'it';
        ...
        const i18n = {
            it: {
                ...
                "info_search": "Cerca un oggetto non in lista. L'AI interrogherà l'università di Strasburgo (SIMBAD) per scaricare le coordinate assolute.",
                "info_setup": "Inquadra il bersaglio sulla mappa. Se è troppo grande, attiva la modalità 'Mosaico' per far dividere automaticamente all'AI i tempi notturni.",
                ...
                "info_dither": "Muove leggermente la montatura tra uno scatto e l'altro per ridurre il rumore. L'AI sottrarrà i secondi persi dal totale disponibile.",
                ...
                "mn_target_ai_label": "🤖 Target AI Consigliato",
            ...
            en: {
                ...
                "mn_target_ai_label": "🤖 AI Recommended Target",
            ...
            es: {
                ...
                "mn_target_ai_label": "🤖 Objetivo Recomendado por IA",
            ...
            zh: {
                ...
                "info_search": "如果本地数据库没有，AI 将连接斯特拉斯堡 (SIMBAD) 获取坐标。",
                "info_setup": "计算视场。如果目标太大，请选择'拼接'，AI 会将黑夜时间分配给各面板。",
                "info_smart": "AI 根据可用黑夜时间自动分配最佳曝光参数。",
                "info_dither": "微调赤道仪位置以减少噪点。AI 会在计算时间时扣除抖动丢失的秒数。",
