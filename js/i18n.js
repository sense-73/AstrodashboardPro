...
let lang = localStorage.getItem('ad_lang') || 'it';
	...
	i18n.it.info_map = "Mappa Empirica di Visibilità. Visualizza un raggio simbolico di 50 km per mostrarti a colpo d'occhio le reali condizioni del cielo. La sovrapposizione dei vari strati ti farà capire subito se la serata sarà limpida o compromessa. Usa i bottoni superiori per attivare i filtri meteo (Nuvole, Jet Stream, Umidità) e scorri la linea temporale per prevedere la loro evoluzione nelle prossime ore.";
        ...
        i18n.it.seeing_4_label = "Buono";
        i18n.it.seeing_5_label = "Ottimo";
        i18n.it.seeing_1_desc  = "Blob enorme e turbolento, inutilizzabile";
        i18n.it.seeing_2_desc  = "Blob diffuso irregolare, nessun anello visibile";
        i18n.it.seeing_3_desc  = "Disco e anelli fusi, alone più ampio, stabilità intermittente";
        i18n.it.seeing_4_desc  = "Anelli parzialmente mossi, brevi momenti di calma";
        i18n.it.seeing_5_desc  = "Disco di Airy e anelli stabili, alta risoluzione possibile";
        ...
        i18n.en.seeing_4_label = "Good";
        i18n.en.seeing_5_label = "Excellent";
        i18n.en.seeing_1_desc  = "Huge turbulent blob, unusable";
        i18n.en.seeing_2_desc  = "Irregular diffuse blob, no rings visible";
        i18n.en.seeing_3_desc  = "Disk and rings merged, wider halo, intermittent stability";
        i18n.en.seeing_4_desc  = "Rings partially blurred, brief moments of calm";
        i18n.en.seeing_5_desc  = "Airy disk and rings stable, high resolution possible";
        ...
        i18n.es.seeing_4_label = "Bueno";
        i18n.es.seeing_5_label = "Excelente";
        i18n.es.seeing_1_desc  = "Blob enorme y turbulento, inutilizable";
        i18n.es.seeing_2_desc  = "Blob difuso irregular, sin anillos visibles";
        i18n.es.seeing_3_desc  = "Disco y anillos fusionados, halo más amplio, estabilidad intermitente";
        i18n.es.seeing_4_desc  = "Anillos parcialmente borrosos, momentos de calma";
        i18n.es.seeing_5_desc  = "Disco de Airy y anillos estables, alta resolución posible";
        ...
        i18n.zh.seeing_4_label = "良好";
        i18n.zh.seeing_5_label = "极佳";
        i18n.zh.seeing_1_desc  = "巨大湍流斑，无法使用";
        i18n.zh.seeing_2_desc  = "不规则弥散斑，无衍射环";
        i18n.zh.seeing_3_desc  = "艾里斑与衍射环融合，弥散晕更大，稳定性间歇";
        i18n.zh.seeing_4_desc  = "衍射环部分模糊，偶有平静时刻";
        i18n.zh.seeing_5_desc  = "艾里斑和衍射环稳定清晰，可实现高分辨率";
