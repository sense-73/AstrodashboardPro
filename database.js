...
// Nomi di Catalogo Ufficiali multilingua
// ==========================================

const dsoDatabase = [
    // ==========================================
    // PARTE 1: CATALOGO MESSIER (Grandi Classici)
    // ==========================================
    { 
        id: "m1", name: "M1", icon: "💥", ra: 5.575, dec: 22.016, 
    ...
    { 
        id: "m3", name: "M3", icon: "🎇", ra: 13.705, dec: 28.377, 
    ...
    { 
        id: "m4", name: "M4", icon: "🎇", ra: 16.393, dec: -26.525, 
    ...
    { 
        id: "m8", name: "M8", icon: "🌊", ra: 18.06, dec: -24.38, 
    ...
    { 
        id: "m11", name: "M11", icon: "🦆", ra: 18.85, dec: -6.27, 
    ...
    { 
        id: "m13", name: "M13", icon: "🎇", ra: 16.69, dec: 36.46, 
    ...
    { 
        id: "m16", name: "M16", icon: "🦅", ra: 18.31, dec: -13.81, 
    ...
    { 
        id: "m17", name: "M17", icon: "🦢", ra: 18.34, dec: -16.17, 
        it: "Nebulosa Omega", en: "Omega Nebula (Swan)", es: "Nebulosa Omega", zh: "天鹅星云",
    ...
    { 
        id: "m20", name: "M20", icon: "🌸", ra: 18.03, dec: -22.90, 
    ...
    { 
        id: "m27", name: "M27", icon: "🦋", ra: 19.99, dec: 22.72, 
    ...
    { 
        id: "m31", name: "M31", icon: "🌌", ra: 0.71, dec: 41.26, 
    ...
    { 
        id: "m33", name: "M33", icon: "🌀", ra: 1.56, dec: 30.66, 
    ...
    { 
        id: "m42", name: "M42", icon: "🌌", ra: 5.58, dec: -5.39, 
    ...
    { 
        id: "m45", name: "M45", icon: "✨", ra: 3.78, dec: 24.11, 
    ...
    { 
        id: "m51", name: "M51", icon: "🌀", ra: 13.49, dec: 47.19, 
    ...
    { 
        id: "m57", name: "M57", icon: "🍩", ra: 18.89, dec: 33.02, 
    ...
    { 
        id: "m63", name: "M63", icon: "🌻", ra: 13.26, dec: 42.03, 
    ...
    { 
        id: "m64", name: "M64", icon: "👁️", ra: 12.95, dec: 21.68, 
    ...
    { 
        id: "m74", name: "M74", icon: "👻", ra: 1.61, dec: 15.79, 
    ...
    { 
        id: "m78", name: "M78", icon: "👻", ra: 5.78, dec: 0.07, 
    ...
    { 
        id: "m81", name: "M81", icon: "🌀", ra: 9.92, dec: 69.06, 
    ...
    { 
        id: "m82", name: "M82", icon: "🚬", ra: 9.93, dec: 69.67, 
    ...
    { 
        id: "m97", name: "M97", icon: "🦉", ra: 11.24, dec: 55.01, 
    ...
    { 
        id: "m101", name: "M101", icon: "🌀", ra: 14.05, dec: 54.34, 
    ...
    { 
        id: "m104", name: "M104", icon: "🛸", ra: 12.66, dec: -11.62, 
    ...
    { 
        id: "m106", name: "M106", icon: "🌀", ra: 12.31, dec: 47.30, 
    ...
    // ==========================================
    // PARTE 2: GRANDI NEBULOSE E CATALOGO NGC / IC
    // ==========================================
    { 
        id: "ic1805", name: "IC 1805", icon: "❤️", ra: 2.55, dec: 61.45, 
    ...
    { 
        id: "ic1848", name: "IC 1848", icon: "👻", ra: 2.85, dec: 60.40, 
    ...
    { 
        id: "ic1396", name: "IC 1396", icon: "🐘", ra: 21.65, dec: 57.50, 
    ...
    { 
        id: "ic5070", name: "IC 5070", icon: "🦤", ra: 20.85, dec: 44.35, 
    ...
    { 
        id: "ngc7000", name: "NGC 7000", icon: "🌎", ra: 20.98, dec: 44.33, 
    ...
    { 
        id: "ngc2244", name: "NGC 2244", icon: "🌹", ra: 6.53, dec: 4.98, 
    ...
    { 
        id: "ngc6888", name: "NGC 6888", icon: "🌙", ra: 20.20, dec: 38.35, 
    ...
    { 
        id: "ngc6960", name: "NGC 6960", icon: "🧹", ra: 20.76, dec: 30.71, 
    ...
    { 
        id: "ngc6992", name: "NGC 6992", icon: "🕸️", ra: 20.94, dec: 31.72, 
    ...
    { 
        id: "ngc7293", name: "NGC 7293", icon: "👁️", ra: 22.49, dec: -20.83, 
    ...
    { 
        id: "ngc1499", name: "NGC 1499", icon: "🏖️", ra: 4.05, dec: 36.42, 
    ...
    { 
        id: "ngc281", name: "NGC 281", icon: "👾", ra: 0.88, dec: 56.62, 
    ...
    { 
        id: "ngc869", name: "NGC 869/884", icon: "✨", ra: 2.33, dec: 57.14, 
    ...
    { 
        id: "ngc5907", name: "NGC 5907", icon: "🌌", ra: 15.26, dec: 56.33, 
    ...
    { 
        id: "ngc5092", name: "NGC 5092", icon: "🌌", ra: 13.33, dec: -23.00, 
    ...
    { 
        id: "ngc891", name: "NGC 891", icon: "🪡", ra: 2.37, dec: 42.34, 
    ...
    { 
        id: "ngc7331", name: "NGC 7331", icon: "🦌", ra: 22.62, dec: 34.41, 
    ...
    { 
        id: "ngc4565", name: "NGC 4565", icon: "🪡", ra: 12.60, dec: 25.99, 
    ...
    { 
        id: "ngc253", name: "NGC 253", icon: "🌪️", ra: 0.79, dec: -25.28, 
    ...
    { 
        id: "ic434", name: "IC 434", icon: "🐴", ra: 5.68, dec: -2.46, 
    ...
    { 
        id: "markarian", name: "Markarian's Chain", icon: "⛓️", ra: 12.45, dec: 13.10, 
    ...
    { 
        id: "stephan", name: "HCG 92", icon: "🖐️", ra: 22.60, dec: 33.96, 
    ...
    { 
        id: "sh2-155", name: "Sh2-155", icon: "🦇", ra: 22.95, dec: 62.62, 
